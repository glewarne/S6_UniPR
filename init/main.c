 ...
 */
	...
	else if (strstr(boot_command_line, "G920R"))
	{
		pr_alert("FOUND G920R VARIANT");
		variant_aif_required = HAS_AIF;
		variant_edge = NOT_EDGE;
		model_type = VARDET_G920R;
	}
	else if (strstr(boot_command_line, "G925R"))
	{
		pr_alert("FOUND G925R VARIANT");
		variant_aif_required = HAS_AIF;
		variant_edge = IS_EDGE;
		model_type = VARDET_G925R;
	}
	else
